<nav x-data="{ open: false }" class="bg-black border-b border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <img src="{{ asset('images/pinnaclelogo.png') }}" alt="Logo" class="h-12 w-auto">
                    </a>
                </div>
    ...
    <div class="pt-2 pb-3 space-y-1">
        <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-gray-700 hover:bg-gray-700 hover:text-gray-300">
            {{ __('Dashboard') }}
        </x-responsive-nav-link>
        <x-responsive-nav-link :href="route('performances.index')" :active="request()->routeIs('performances.index')" class="text-gray-700 hover:bg-gray-700 hover:text-gray-300">
            {{ __('Performances') }}
        </x-responsive-nav-link>
    </div>
